# DeviceEvents ActionType Reference Guide
...
* [Exploit Guard](#exploit-guard)
* [System & Process Integrity](#system--process-integrity)
* [Network, Firewall & Cloud](#network-firewall--cloud)
* [User Accounts & Active Directory](#user-accounts--active-directory)
* [Device & Peripheral Control](#device--peripheral-control)
* [SmartScreen & Browsing](#smartscreen--browsing)

---

## Antivirus & Malware
*Telemetry regarding the state and actions of the Microsoft Defender Antivirus engine.*
...
*Events triggered by specific ASR rules designed to block common malware vectors.*
...
*Monitoring for untrusted applications and code integrity policy enforcement.*
...
## Exploit Guard
*Telemetry regarding Arbitrary Code Guard (ACG), memory protection, and exploit mitigations.*
...
*Low-level OS events including WMI, PowerShell, memory manipulation, and API monitoring.*
...
| `DpapiAccessed` | Description of saved sensitive data encrypted using DPAPI.  |
...
*Firewall enforcement, network connections, and cloud-based security analysis.*
...
*Identity-based telemetry for account creation, modification, and group membership changes.*
...
*Telemetry for USB devices, Bluetooth, printers, and removable media.*
...
| `ExternalDeviceConnected` | A peripheral connected to this device.  |
| `ExternalDeviceDisconnected` | A peripheral disconnected from this device.  |
...
## SmartScreen & Browsing
*Telemetry for containerized browsing, URL reputations, and file security.*
...
---
*Created for the [AttacktheSOC/Azure-SecOps](https://github.com/AttacktheSOC/Azure-SecOps) repository.*
